...
import './js/name-card-holder_validation.js';
import './js/card-number__validation.js';
import './js/cvv_validation.js';
...
import './scss/back-side-card.scss';
import './scss/payment-button.scss';
